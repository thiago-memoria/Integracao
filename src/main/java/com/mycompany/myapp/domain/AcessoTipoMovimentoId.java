...
public class AcessoTipoMovimentoId implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return funcionariosEmpresa != null && tiposMovimento != null
				&& funcionariosEmpresa.equals(((AcessoTipoMovimentoId) o).funcionariosEmpresa)
				&& tiposMovimento.equals(((AcessoTipoMovimentoId) o).tiposMovimento);
	}
